...
//     // قسم الطلبات
//     { to: "/AdminDashboard/Request", icon: faListAlt, label: "طلبات القوائم" },
//     { to: "/AdminDashboard/Debate", icon: faChalkboard, label: "طلبات المناظرة" }
//   ];
        ...
        <nav>
          {menuItems.map((item, index) => (
            ...
            >
              ...
              {item.label}
              {item.unreadCount > 0 && (
                <span className="absolute top-0 right-0 bg-red-600 text-white text-xs rounded-full px-2 py-0.5 -translate-x-1/2 translate-y-1/2">
                  {item.unreadCount}
                </span>
              )}
            </Link>
