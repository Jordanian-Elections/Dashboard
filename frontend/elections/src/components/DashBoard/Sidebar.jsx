...
//     { to: "/AdminDashboard/Ads", icon: faDollarSign, label: "الاعلانات" },
//     { to: "/AdminDashboard/Chats", icon: faDollarSign, label: "المحادثات" },
//     { to: "/AdminDashboard/Messages", icon: faDollarSign, label: "الرسائل" },
//     { to: "/AdminDashboard/Result", icon: faDollarSign, label: "النتائج" },
//     { to: "/AdminDashboard/Depete", icon: faDollarSign, label: "طلبات المناظرة" },
...
import {
  ...
  faVoteYea // Updated icon for results and debates
} from "@fortawesome/free-solid-svg-icons";
import Swal from "sweetalert2";
...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    { to: "/AdminDashboard/Chats", icon: faCommentDots, label: "المحادثات" }, // Updated icon
    { to: "/AdminDashboard/Messages", icon: faEnvelope, label: "الرسائل" }, // Updated icon
    { to: "/AdminDashboard/Result", icon: faVoteYea, label: "النتائج" }, // Updated icon
    { to: "/AdminDashboard/Debate", icon: faChalkboard, label: "طلبات المناظرة" }, // Updated icon
    { to: "/AdminDashboard/Settings", icon: faCog, label: "الإعدادات" },
  ];
