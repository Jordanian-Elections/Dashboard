...
//       setLoading(true);
//       try {
//         const response = await axios.get('http://localhost:3001/api/revenue');
//         setData(response.data);
        
//         // Format data for the main chart
//         const labels = response.data.map(item => new Date(item.created_at).toLocaleDateString('ar-EG'));
...
//             return `الإيرادات: ${tooltipItem.raw.toLocaleString('ar-EG')} دينار أردني`;
//           },
//         },
//       },
//     },
...
//       className="bg-white p-4 rounded-lg shadow-md flex items-center space-x-4 rtl:space-x-reverse"
//     >
...
//               {totalAmount.toLocaleString('ar-EG', { minimumFractionDigits: 2 })} دينار أردني
//             </p>
//           </div>
//         </CardWrapper>
//         {/* <CardWrapper icon={Calendar}>
//           <div>
//             <p className="text-sm text-gray-500">متوسط الإيرادات اليومية</p>
//             <p className="text-xl font-semibold">
//               {(data.reduce((sum, item) => sum + item.amount, 0) / data.length).toLocaleString('ar-EG', { maximumFractionDigits: 2 })} دينار أردني
//             </p>
//           </div>
//         </CardWrapper> */}
...
//         >
//           <h2 className="text-xl font-semibold mb-4">الاتجاهات الشهرية</h2>
...
//                   >
//                     <td className="py-4 px-6">{new Date(item.created_at).toLocaleDateString('ar-EG')}</td>
//                     <td className="py-4 px-6">{item.amount.toLocaleString('ar-EG')} دينار أردني</td>
//                   </motion.tr>
//                 ))}
//               </tbody>
//             </table>
